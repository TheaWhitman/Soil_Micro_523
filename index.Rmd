...
Copyright (c) [Data Carpentry](https://datacarpentry.org)
...
how to work with databases directly from R. For Soil Micro 523, we will be working through the first two exercises.
...
Data for the lesson is available [here](https://raw.githubusercontent.com/TheaWhitman/Soil_Micro_523/master/Atacama_sample_metadata.csv).
